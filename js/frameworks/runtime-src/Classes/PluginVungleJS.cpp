...
#endif
JSClass  *jsb_sdkbox_PluginVungle_class;
JSObject *jsb_sdkbox_PluginVungle_prototype;
...
bool js_PluginVungleJS_PluginVungle_setUserID(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginVungleJS_PluginVungle_setUserID : Error processing arguments");
        sdkbox::PluginVungle::setUserID(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginVungleJS_PluginVungle_setUserID : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginVungleJS_PluginVungle_show(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_PluginVungleJS_PluginVungle_show : Error processing arguments");
        sdkbox::PluginVungle::show(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginVungleJS_PluginVungle_show : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginVungleJS_PluginVungle_init(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginVungleJS_PluginVungle_init : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginVungleJS_PluginVungle_setDebug(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    if (argc == 1) {
        ...
        JSB_PRECONDITION2(ok, cx, false, "js_PluginVungleJS_PluginVungle_setDebug : Error processing arguments");
        sdkbox::PluginVungle::setDebug(arg0);
        args.rval().setUndefined();
        return true;
    }
    JS_ReportError(cx, "js_PluginVungleJS_PluginVungle_setDebug : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
bool js_PluginVungleJS_PluginVungle_isCacheAvailable(JSContext *cx, uint32_t argc, jsval *vp)
{
    ...
    JS_ReportError(cx, "js_PluginVungleJS_PluginVungle_isCacheAvailable : wrong number of arguments");
    return false;
}
#elif defined(JS_VERSION)
...
void js_PluginVungleJS_PluginVungle_finalize(JSFreeOp *fop, JSObject *obj) {
    CCLOGINFO("jsbindings: finalizing JS object %p (PluginVungle)", obj);
    js_proxy_t* nproxy;
    js_proxy_t* jsproxy;
    ...
    if (jsproxy) {
        ...
        sdkbox::PluginVungle *nobj = static_cast<sdkbox::PluginVungle *>(nproxy->ptr);
        if (nobj)
            delete nobj;
...
void js_register_PluginVungleJS_PluginVungle(JSContext *cx, JS::HandleObject global) {
    ...
    jsb_sdkbox_PluginVungle_class->delProperty = JS_DeletePropertyStub;
...
#if (SDKBOX_COCOS_JSB_VERSION >= 2)
    JS::RootedObject proto(cx, jsb_sdkbox_PluginVungle_prototype);
    jsb_register_class<sdkbox::PluginVungle>(cx, jsb_sdkbox_PluginVungle_class, proto, JS::NullPtr());
#else
